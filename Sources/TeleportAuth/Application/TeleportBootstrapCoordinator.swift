...
public enum TeleportBootstrapState: Equatable {
    case idle
...
@MainActor
public protocol TeleportBootstrapCoordinating: AnyObject, ObservableObject {
...
public final class TeleportBootstrapCoordinator: ObservableObject, TeleportBootstrapCoordinating {
    ...
    public private(set) var lastBootstrapResult: BootstrapResult?
