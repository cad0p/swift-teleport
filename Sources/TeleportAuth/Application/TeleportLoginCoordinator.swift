...
public enum TeleportLoginState: Equatable {
    case idle
...
public enum TeleportLoginError: Error, Equatable {
...
@MainActor
public protocol TeleportLoginCoordinating: AnyObject, ObservableObject {
...
@MainActor
public final class TeleportLoginCoordinator: ObservableObject, TeleportLoginCoordinating {
    @Published public private(set) var state: TeleportLoginState = .idle
