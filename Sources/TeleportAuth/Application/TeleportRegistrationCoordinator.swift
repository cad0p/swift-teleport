...
public enum TeleportRegistrationState: Equatable {
    case idle
...
public enum TeleportRegistrationError: Error, Equatable {
...
@MainActor
public protocol TeleportRegistrationCoordinating: AnyObject, ObservableObject {
