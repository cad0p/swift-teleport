...
/// `nonisolated`: every member is a pure function over its arguments (no
/// shared mutable state), and the transport actor's nonisolated statics call
/// them directly. Swift 6 language mode promotes the host app's default-
/// MainActor isolation to a hard error otherwise.
nonisolated public enum TeleportTLSTrust {
    ...
    public struct ParsedExtensions {
        ...
        public var recognizedExtensionOIDs: Set<[UInt8]> = []
    }
