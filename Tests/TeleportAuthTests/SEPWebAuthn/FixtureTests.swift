...
//    1. `@testable import TeleportCore` (was `@testable import SEPWebAuthn`) —
//       the SEPWebAuthn sources now live in the swift-teleport package.
...
nonisolated final class FixtureTests: XCTestCase {
    ...
    private func fixtureBaseURL() -> URL {
        ...
        return URL(fileURLWithPath: #filePath)
            ...
            .appendingPathComponent("Fixtures/SEPWebAuthn")
    }
