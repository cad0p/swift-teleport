...
// target's `.defaultIsolation(MainActor.self)` cannot apply to the class (it
// would synthesize MainActor-isolated overrides). The test methods opt back in
// with `@MainActor` (Swift 6 language mode).
nonisolated final class TeleportCredentialTests: XCTestCase {
