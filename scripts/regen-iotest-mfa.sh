...
#
# Regenerate Sources/TeleportCore/Infrastructure/iotest_mfa.pb.swift from
...
#      TeleportCore/TeleportAuth/TeleportTesting module boundaries;
#   2. normalizes the `nonisolated` modifiers on every generated type, enum,
#      and the file-private package constant. Every package target builds with
...
PROTO_DIR="Sources/TeleportCore/Infrastructure"
